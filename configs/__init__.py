...
cfgs = {
    "ssd_cfg.py": ["ssd", ssd_cfg.Config()],
    "centernet_cfg.py": ["centernet", centernet_cfg.Config()],
    "yolov3_cfg.py": ["yolov3", yolov3_cfg.Config()],
    "yolo7_cfg.py": ["yolo_v7", yolo7_cfg.Config()],
}
